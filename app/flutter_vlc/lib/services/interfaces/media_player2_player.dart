...
class OrgMprisMediaPlayer2PlayerTrackListReplaced extends DBusSignal {
  ...
  OrgMprisMediaPlayer2PlayerTrackListReplaced(DBusSignal signal)
    : super(
...
class OrgMprisMediaPlayer2PlayerTrackAdded extends DBusSignal {
  Map<String, DBusValue> get arg_0 =>
      values[0].asArray()[0].asStringVariantDict();
  DBusObjectPath get arg_1 => values[1].asObjectPath();

  OrgMprisMediaPlayer2PlayerTrackAdded(DBusSignal signal)
    : super(
        sender: signal.sender,
        path: signal.path,
        interface: signal.interface,
...
class OrgMprisMediaPlayer2PlayerTrackRemoved extends DBusSignal {
  ...
  OrgMprisMediaPlayer2PlayerTrackRemoved(DBusSignal signal)
    : super(
        sender: signal.sender,
        path: signal.path,
        interface: signal.interface,
...
class OrgMprisMediaPlayer2PlayerTrackMetadataChanged extends DBusSignal {
  ...
  OrgMprisMediaPlayer2PlayerTrackMetadataChanged(DBusSignal signal)
    : super(
        sender: signal.sender,
        path: signal.path,
        interface: signal.interface,
...
class OrgMprisMediaPlayer2Player extends DBusRemoteObject {
  ...
  late final Stream<OrgMprisMediaPlayer2PlayerTrackListReplaced>
  trackListReplaced;
  ...
  late final Stream<OrgMprisMediaPlayer2PlayerTrackMetadataChanged>
  ...
  OrgMprisMediaPlayer2Player(
    ...
    trackListReplaced =
        DBusRemoteObjectSignalStream(
          ...
          (signal) => OrgMprisMediaPlayer2PlayerTrackListReplaced(signal),
        );
    ...
    trackAdded =
        DBusRemoteObjectSignalStream(
          ...
          interface: 'MediaPlayer2.TrackList',
          name: 'TrackAdded',
          signature: DBusSignature('aa{sv}o'),
        ).asBroadcastStream().map(
          (signal) => OrgMprisMediaPlayer2PlayerTrackAdded(signal),
        );
    ...
    trackRemoved =
        DBusRemoteObjectSignalStream(
          ...
          (signal) => OrgMprisMediaPlayer2PlayerTrackRemoved(signal),
        );
    ...
    trackMetadataChanged =
        DBusRemoteObjectSignalStream(
          ...
          (signal) => OrgMprisMediaPlayer2PlayerTrackMetadataChanged(signal),
        );
  }
  ...
  Future<void> callSetPosition(
    DBusObjectPath arg_0,
    int arg_1, {
    bool noAutoStart = false,
    bool allowInteractiveAuthorization = false,
  }) async {
  ...
  Future<void> callAddTrack(
    ...
    await callMethod(
      'org.mpris.MediaPlayer2.TrackList',
      'AddTrack',
      [DBusString(arg_0), arg_1, DBusBoolean(arg_2)],
      replySignature: DBusSignature(''),
      noAutoStart: noAutoStart,
      allowInteractiveAuthorization: allowInteractiveAuthorization,
    );
